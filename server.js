...
app.post('/api/migrate', (req, res) => {
  const { tradeMemory, learnedThresholds, adaptationCount, closedPositions, openPositions, pnlHistory, watchlist, autoCount } = req.body;
  ...
  if (openPositions != null) store.set('openPositions',    openPositions);
